...
const th: Dictionary = {
  ...
  plan: {
    title: "แผนของเรา",
    description:
      "เปลี่ยนประเทศไทยให้เป็น Shenzhen แห่ง Southeast Asia ด้วยบูตแคมป์ฮิวแมนนอยด์ ธุรกิจติดตั้งหุ่นยนต์ และโรงงานชิ้นส่วน — แต่ละก้าวจะต่อยอดไปอีกก้าว",
    home: "หน้าแรก",
    heading: "เปลี่ยนประเทศไทยให้เป็น Shenzhen แห่ง Southeast Asia",
    date: "กรุงเทพฯ · 2026",
    paragraphs: [
      "หุ่นยนต์ทั่วโลกมักถูกคิดขึ้นในประเทศหนึ่ง แล้วไปประกอบอีกประเทศหนึ่ง แต่เราไม่เชื่อว่าคลื่นลูกต่อไปอย่างฮิวแมนนอยด์ต้องเดินตามแผนที่เดิมเสมอไป เราออกแบบ สร้าง และส่งออกจากตรงนี้ได้",
      "เพราะเราจะผลิตสิ่งที่ยังสร้างไม่เป็นไม่ได้ และจะสร้างไม่เป็นถ้าไม่เคยมีใครสอน เราเลยเริ่มที่คนก่อน ไทยมีทั้งเมกเกอร์ ความอยากรู้ และพื้นฐานการผลิตอยู่แล้ว สิ่งที่ยังขาดคือที่ให้เรียนรู้ฮิวแมนนอยด์แบบครบตั้งแต่ต้นจนจบ — ตั้งแต่น็อตตัวแรกจนถึงหุ่นยนต์ที่เดินออกจากประตูได้ นั่นแหละคือจุดที่เราเริ่ม",
      "แล้วจากตรงนั้น ทุกอย่างจะค่อย ๆ ต่อกันไป คนที่สร้างเป็นจะเติบโตเป็นธุรกิจที่เอาหุ่นยนต์ไปทำงาน และธุรกิจนั้นก็ช่วยสร้างทุนให้โรงงานผลิตชิ้นส่วน",
    ],
    emphasis: "แต่ละก้าวจะต่อยอดไปอีกก้าว",
    short: "สรุปง่าย ๆ แผนของเราคือ:",
    steps: [
      [
        "สร้างบูตแคมป์ฮิวแมนนอยด์",
        "สอนให้ทุกคนสร้างฮิวแมนนอยด์ได้ครบตั้งแต่ต้นจนจบ ทั้งประกอบ จำลอง และนำไปใช้งาน บนแพลตฟอร์มโอเพนซอร์สของจริง",
      ],
      [
        "เป็นทีมติดตั้งหุ่นยนต์",
        "เอากำไรและคนเก่งที่เราปั้นขึ้นมา พาฮิวแมนนอยด์ไปทำงานในอุตสาหกรรมไทย",
      ],
      [
        "ผลิตชิ้นส่วน",
        "เอากำไรมาผลิตแอคชูเอเตอร์และเซนเซอร์ที่ตลาดอะไหล่ทดแทนต้องใช้",
      ],
    ],
    closing: "สามก้าว หนึ่งเป้าหมาย",
    closingHighlight: "รุ่นแรกเริ่มไตรมาส 4 ปี 2026",
    join: "สมัคร",
  },
};
